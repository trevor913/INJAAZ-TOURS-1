        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          {destinations.map((destination, index) => (
            ...
            >
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <div className="flex items-center text-xs sm:text-sm text-gray-500">
                    <Clock className="h-3 w-3 sm:h-4 sm:w-4 ml-1 sm:ml-2 text-yellow-500 flex-shrink-0" />
                    <span className="mr-1 sm:mr-2">{language === 'en' ? 'Duration:' : 'المدة:'}</span>
                    <span className="font-medium">{destination.duration}</span>
                  </div>
                  <div className="flex items-center text-xs sm:text-sm text-gray-500">
                    <Star className="h-3 w-3 sm:h-4 sm:w-4 ml-1 sm:ml-2 text-yellow-500 flex-shrink-0" />
                    <span className="mr-1 sm:mr-2">{language === 'en' ? 'Best Time:' : 'أفضل وقت:'}</span>
                ...
                <div className="mb-4 sm:mb-6">
                  ...
                  <div className="pl-3 border-l-2 border-green-700 ml-3 space-y-1 mt-1">
                
                <button onClick={() => { setIsDestinationsOpen(!isDestinationsOpen); setIsToursOpen(false); }} className="w-full flex justify-between items-center px-3 py-2 text-white hover:bg-green-800 rounded-md transition-colors">
              ...
              <Link to="/about" className="block px-3 py-2 text-white hover:bg-green-800 rounded-md transition-colors" onClick={() => setIsOpen(false)}>
        <div className="mt-20 text-center bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-12 text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              ...
              <Link to="/contact" className="block px-3 py-2 text-white hover:bg-green-800 rounded-md transition-colors" onClick={() => setIsOpen(false)}>
            <Link
              to="/tours"
              <Link to="/request-quote" className="block px-3 py-2 bg-gradient-to-r from-yellow-400 to-yellow-600 text-white rounded-lg text-center font-medium mt-2" onClick={() => setIsOpen(false)}>
            >

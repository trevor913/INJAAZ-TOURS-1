  ...
  return (
    <div className="relative isolate overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-6 sm:mb-8 lg:mb-12 text-white">
        ...
        {/* Form */}
        <form onSubmit={handleSubmit} className="bg-white rounded-xl lg:rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 xl:p-12">
          {/* Personal Information */}
          <div className="mb-6 sm:mb-8 lg:mb-10 xl:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-green-800 mb-3 sm:mb-4 lg:mb-6 flex items-center">
              <Users className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 ml-2 text-yellow-600" />
          ...
          <div className="mb-6 sm:mb-8 lg:mb-10 xl:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-green-800 mb-3 sm:mb-4 lg:mb-6 flex items-center">
              <Calendar className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 ml-2 text-yellow-600" />
          ...
          <div className="mb-6 sm:mb-8 lg:mb-10 xl:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-green-800 mb-3 sm:mb-4 lg:mb-6 flex items-center">
              <MapPin className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 ml-2 text-yellow-600" />
              {language === 'en' ? 'Desired Destinations' : 'الوجهات المرغوبة'}
            </h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 lg:gap-4">
              {destinations.map((destination) => (
                <label key={destination.id} className="flex items-center space-x-2 rtl:space-x-reverse p-2 sm:p-3 rounded-lg hover:bg-gray-50 cursor-pointer">
                  <input
                    type="checkbox"
                    name="destinations"
                  ...
                  />
                  <span className="text-gray-700 text-sm">{destination.name}</span>
                </label>
              ))}
            </div>
          </div>
          ...
          <div className="mb-6 sm:mb-8 lg:mb-10 xl:mb-12">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-green-800 mb-3 sm:mb-4 lg:mb-6 flex items-center">
              <Clock className="h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 ml-2 text-yellow-600" />
              {language === 'en' ? 'Interests' : 'الاهتمامات'}
            </h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 lg:gap-4">
              {interests.map((interest) => (
                <label key={interest.id} className="flex items-center space-x-2 rtl:space-x-reverse p-2 sm:p-3 rounded-lg hover:bg-gray-50 cursor-pointer">
                  <input
                    type="checkbox"
                    name="interests"
                    value={interest.id}
          ...
          <div className="mb-4 sm:mb-6 lg:mb-8">
            <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-green-800 mb-3 sm:mb-4 lg:mb-6">{language === 'en' ? 'Special Requests' : 'طلبات خاصة'}</h2>
            <textarea
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-green-600 to-green-700 text-white px-6 py-3 sm:py-4 rounded-lg text-sm sm:text-base lg:text-lg font-semibold hover:from-green-700 hover:to-green-800 transition-all transform hover:scale-105 flex items-center justify-center"
          >
        ...
        {/* Additional Info */}
        <div className="mt-6 sm:mt-8 lg:mt-10 xl:mt-12 bg-black/20 backdrop-blur-sm rounded-xl lg:rounded-2xl p-4 sm:p-6 lg:p-8 text-white text-center">
          ...
          <div className="flex flex-col xs:flex-row justify-center gap-3 sm:gap-4">
            <a
              ...
              className="bg-white text-yellow-600 px-4 py-2 sm:py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors text-sm"
            >
              WhatsApp: +254 712 346 678
            </a>
            <a
              href="tel:+254712346678"
              className="bg-green-600 text-white px-4 py-2 sm:py-3 rounded-full font-semibold hover:bg-green-700 transition-colors text-sm"
            >

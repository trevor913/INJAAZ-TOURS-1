...
export const Navbar = () => {
  ...
  return (
    <nav className="bg-jungle-green shadow-lg sticky top-0 z-50 w-full">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        <div className="flex justify-between items-center py-2 min-h-[64px]">
          ...
          <div className="hidden lg:flex items-center space-x-6 xl:space-x-8 rtl:space-x-reverse">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 w-48 bg-jungle-green rounded-lg shadow-lg py-2 border opacity-0 group-hover:opacity-100 group-hover:scale-100 scale-95 transform transition-all duration-300 ease-in-out z-50">
        ...
        {isOpen && (
          <div className="lg:hidden">
            <div className="px-2 pt-2 pb-4 space-y-1 bg-jungle-green border-t border-green-700">
              ...
              <Link to="/request-quote" className="block px-3 py-3 bg-gradient-to-r from-yellow-400 to-yellow-600 text-white rounded-lg text-center font-medium mt-2" onClick={() => setIsOpen(false)}>
                {language === 'en' ? 'Request Quote' : 'طلب عرض سعر'}
              </Link>
            </div>
          </div>
